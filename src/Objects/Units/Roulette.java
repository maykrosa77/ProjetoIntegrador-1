...
public class Roulette extends BasicUnit{
	
	public Roulette(BufferedImage image, float x, float y, int numberAnimations, int numberFrames, int placeIDMap, Squad yourSquad){
