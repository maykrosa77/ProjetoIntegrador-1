...
public class Devastating extends BasicUnit{
	
	public Devastating(BufferedImage image, float x, float y, int numberAnimations, int numberFrames, int placeIDMap, Squad yourSquad){
