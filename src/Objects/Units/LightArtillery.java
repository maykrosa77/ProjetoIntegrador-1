...
public class LightArtillery extends BasicUnit{
	
	public LightArtillery(BufferedImage image, float x, float y, int numberAnimations, int numberFrames, int placeIDMap, Squad yourSquad){
