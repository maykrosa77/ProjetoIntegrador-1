...
public class HeavyArtillery extends BasicUnit{
	
	public HeavyArtillery(BufferedImage image, float x, float y, int numberAnimations, int numberFrames, int placeIDMap, Squad yourSquad){
