...
public class MenuScene extends Scene{
    ...
    */
    public MenuScene(GamePanel gamePanel){
       ...
       startRect      = new Rectangle((int)(width*0.35f), (int)(height*0.65f), (int)(width*0.3f), 48);
       languageRect   = new Rectangle((int)(width*0.8f), (int)(height*0.05f), (int)(width*0.05f), (int)(height*0.1f));
       soundTrackRect = new Rectangle((int)(width*0.85f), (int)(height*0.05f), (int)(width*0.05f), (int)(height*0.1f));
       sfxRect        = new Rectangle((int)(width*0.9f), (int)(height*0.05f), (int)(width*0.05f), (int)(height*0.1f));
    }
    ...
    public void mouseReleased(MouseEvent e) {
    	...
    	if(languageRect.contains(e.getPoint())){
    		Language.loadLanguage(Language.currentLanguage==Language.ENGLISH?Language.PORTUGUES:Language.ENGLISH);
    	    languageFlag = Language.currentLanguage==Language.ENGLISH?Image.languageIcons[0]:Image.languageIcons[1];
    	}
    	
    	if(soundTrackRect.contains(e.getPoint())){
    		Sound.soundTrackVolume = Sound.soundTrackVolume==1?0:1;
 	       	soundTrackImage = Sound.soundTrackVolume==1?Image.soundTrackIcons[0]:Image.soundTrackIcons[1];
    	}
    	
    	if(sfxRect.contains(e.getPoint())){
      		Sound.sfxVolume = Sound.sfxVolume==1?0:1;
  	        sfxImage = Sound.sfxVolume==1?Image.sfxIcons[0]:Image.sfxIcons[1];
     	}
    }
    @Override
    ...
    */
    ...
    public void render(Graphics2D graphics) {
        ...
        /*Options*/
        graphics.drawImage(languageFlag, languageRect.x, languageRect.y, languageRect.width, languageRect.height, null);
        graphics.drawImage(soundTrackImage, soundTrackRect.x, soundTrackRect.y, soundTrackRect.width, soundTrackRect.height, null);
        graphics.drawImage(sfxImage, sfxRect.x, sfxRect.y, sfxRect.width, sfxRect.height, null);
